...
{*    {section show=$node.data_map.image.content}
    ...
    {section show=$node.children[0].data_map.image.content}
        <div class="attribute-image">
            {attribute_view_gui image_class=small attribute=$node.children[0].data_map.image href=$node.url_alias|ezurl}
        </div>
    {/section}

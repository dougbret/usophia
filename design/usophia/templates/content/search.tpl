...
<form action={"WikiSophia"|ezurl} method="get" />
    <input class="halfbox" type="text" size="20" name="SearchText" id="Search" value="{$search_text|wash}" />
    <input class="button" name="SearchButton" type="submit" value="{'Search on Wikisophia'|i18n('design/ezwebin/content/search')}" />
</form>
...
{/if}
	...
	<h2>Wikisophia results</h2>
 
	<iframe src="/mediawiki/index.php?title=Special%3ASearch&redirs=0&search={$search_text}&fulltext=Search&ns0=1" width="700" height="300" />
